...
class Main {
    ...
    public static void printFilteredAccounts(List<Account> accounts) {
        ...
        List<Account> accountsWithTooMuchMoney = filter(accounts, (account) -> account.getBalance() > 100000000);

        // Don't change the code below
        nonEmptyAccounts.forEach(a -> System.out.print(a.getNumber() + " and "));
        accountsWithTooMuchMoney.forEach(a -> System.out.print(a.getNumber() + " and "));
    }
